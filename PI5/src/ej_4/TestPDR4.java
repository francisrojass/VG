...
public class TestPDR4 {
	...
	public static void main(String[] args) {
		...
		PDR<EmparejamientoVertex, EmparejamientoEdge, SolucionEmparejamiento> PDR_alg = PDR.of(graph);
		
		GraphPath<EmparejamientoVertex, EmparejamientoEdge> path= PDR_alg.search().get();
		/*
